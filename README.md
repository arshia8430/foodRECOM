...
A modular Python framework for simulating an LLM-persona food recommendation loop with adaptive contextual-bandit and SAC-style policies.
...
- `foodrecom/policies.py` defines LinUCB and SAC-style adaptive policy engines.
